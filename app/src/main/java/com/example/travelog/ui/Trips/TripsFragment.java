...
public class TripsFragment extends Fragment {
        ...
        public static com.example.travelog.ui.Trips.TripsFragment newInstance(String param1, String param2) {
            com.example.travelog.ui.Trips.TripsFragment fragment = new com.example.travelog.ui.Trips.TripsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        itinerary.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getActivity(),Itinerary_create.class);
